            ...
            if not notas_map:
                ...
                <div style="font-family:Arial, sans-serif; font-size:12px; color:black; padding:20px;">
                    ...
                    <div style="display:flex; justify-content:space-between; text-align:center; padding:0 50px;">
                        <div style="border-top:1px solid #000; width:30%; padding-top:5px;">Orientador(a)</div>
                        <div style="border-top:1px solid #000; width:30%; padding-top:5px;">Dirección</div>
                    </div>
                </div>
                """
...
# ==========================================
    ...
    if grado != "Seleccionar..." and materia != "Seleccionar...":
        ...
        if not lista:
            ...
            # 3. Definir Columnas según Materia (Conducta vs Normal)
            if materia == "Conducta":
                cols = ["Nota Conducta"]
            else:
