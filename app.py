...
if opcion_seleccionada == "Inicio":
    ...
    cronograma = [{"Fecha": "02 Ene - 18 Feb", "Actividad": "Matrícula Extraordinaria", "Estado": "En Curso"}, {"Fecha": "15 Ene", "Actividad": "Inicio de labores plantel docente", "Estado": "Programado"}, {"Fecha": "26 Ene", "Actividad": "Inicio de Clases (Oficial)", "Estado": "Realizado"}, {"Fecha": "30 Ene", "Actividad": "Reunión General de Padres de Familia", "Estado": "Pendiente"}]
...
if st.session_state["user_role"] == "admin" and opcion_seleccionada != "Inicio":
    ...
    # --- 4. MAESTROS ---
        ...
        # --- NUEVA LÓGICA: DICCIONARIO PARA ELIMINAR DUPLICADOS Y BÚSQUEDA RÁPIDA ---
        mapa_profesores = {}
        for d in docs_m:
            data = d.to_dict()
        ...
        if sel_prof == "➕ Registrar Nuevo Maestro":
            ...
            if sel_prof in mapa_profesores:
                # Recuperar datos directamente del diccionario (Cero error)
                ...
                with st.container(border=True):
                    ...
                    with c1: 
                        if prof_data.get('foto_url'): st.image(prof_data['foto_url'], width=120)
